...
acceptRequest(id:number):Observable<PatientDetails>
{
  return this.http.put<PatientDetails>(`http://localhost:8000/api/update/patientdetails/${id}/`,{})
}

rejectRequest(id:number):Observable<PatientDetails>
{
  return this.http.patch<PatientDetails>(`http://localhost:8000/api/update/patientdetails/reject/${id}/`,{})
}
